<div class="col-md-12">
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <!-- Menampilkan error jika ada validasi yang gagal -->
            ...
            <div class="form-group mb-3">
                ...
                <input name="coordinat" id="Coordinat" value="<?= old('coordinat') ?>" placeholder="Koordinat Rumah" class="form-control" readonly>
...
<script>
  ...
  var marker = L.marker([<?= $web['coordinat_wilayah'] ?>], {
    draggable: true,
  }).addTo(map);
